...
export default function Resonance() {
  ...
  const [messages, setMessages] = useState<Array<{ role: 'user' | 'assistant'; content: string }>>([
    {
      role: 'assistant',
      content: 'Welcome to Resonance. I\'m here to truly understand you—not just your words, but the feelings and experiences behind them. This is a safe space where you can express yourself freely, without judgment. What\'s on your heart today?'
    }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const responses = [
        "I hear the weight of what you're carrying. It takes courage to share that. Tell me more about how this makes you feel.",
        "Thank you for trusting me with this. Your feelings are completely valid. What do you need most right now?",
        "I can sense the depth of your experience. You're not alone in feeling this way. What would support look like for you?",
        "That sounds incredibly challenging. I want you to know that your emotions matter, and they deserve to be honored. How long have you been feeling this way?",
        "I'm here with you in this moment. Your vulnerability is a strength. What would it feel like to let go of some of this burden?"
      ];
      ...
      <div style={{ minHeight: '100vh', background: '#0a0e27', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px' }}>
        <div style={{ textAlign: 'center', maxWidth: '600px' }}>
          ...
          <p style={{ fontSize: '20px', color: '#a0aec0', marginBottom: '32px' }}>
            Please sign in to experience empathetic AI that truly understands you.
          </p>
          <Button
          ...
          {isLoading && (
            <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
              <div style={{
                ...
                <span style={{ color: '#ffffff', fontSize: '16px' }}>Understanding you...</span>
              </div>
            </div>
          )}
